...
FROM
	...
	/*IF outtypeRack != null*/
	CROSS JOIN RACK_MST_/*$domainId*/ R
	/*END*/
	/*IF outtypeRack == null*/
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = STOCK_QUANTITY_EAD_UNCLOSED.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
   	-- [前月締時点の在庫数]
	(
    	...
    	FROM
    		...
    		INNER JOIN (SELECT PS2.PRODUCT_CODE
			/*IF outtypeRack != null*/
			,PS2.RACK_CODE
			/*END*/
    		, MAX(PS2.STOCK_PDATE) AS STOCK_PDATE FROM PRODUCT_STOCK_TRN_/*$domainId*/ PS2 
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = STOCK_QUANTITY_EAD_CLOSED.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
    -- [委託在庫数]
    (
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = REST_QUANTITY_RO.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
    -- [船便発注残数]
    (
    ...
    ON P.PRODUCT_CODE = REST_QUANTITY_PO_SHIP.PRODUCT_CODE
		/*IF outtypeRack != null*/
		AND R.RACK_CODE = REST_QUANTITY_PO_SHIP.RACK_CODE
		/*END*/
    ...
    ON P.PRODUCT_CODE = REST_QUANTITY_PO_AIR.PRODUCT_CODE
		/*IF outtypeRack != null*/
		AND R.RACK_CODE = REST_QUANTITY_PO_AIR.RACK_CODE
		/*END*/
    LEFT OUTER JOIN
    -- [宅配便発注残数]
    (
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = REST_QUANTITY_PO_DELIVERY.RACK_CODE
	/*END*/
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = REST_QUANTITY_ENTRUST.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
   	    -- [最短入荷日]
    (
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = DELIVERY_DATE.RACK_CODE
	/*END*/
    /*IF aggregateMonthsRange != null*/
	LEFT OUTER JOIN
    -- [受注数量]
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = RO_QUANTITY.RACK_CODE
	/*END*/
    LEFT OUTER JOIN
    -- [出荷数量]
    (
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = SALES_QUANTITY.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
    -- [過去最大出荷数量]
	(
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = MAX_SALES_QUANTITY.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
	-- [売上金額]
	(
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = RETAIL_PRICE_TOTAL.RACK_CODE
	/*END*/
	LEFT OUTER JOIN
	-- [粗利益]
	(
	...
	/*IF outtypeRack != null*/
	AND R.RACK_CODE = GROSS_MARGIN_TOTAL.RACK_CODE
	/*END*/
	/*END*/
	/*IF addPOrderInfo == true */
	INNER JOIN PO_LINE_TRN_/*$domainId*/ POL ON POL.PRODUCT_CODE = P.PRODUCT_CODE 
			/*IF outtypeRack != null*/
			AND R.RACK_CODE = POL.RACK_CODE
			/*END*/
	INNER JOIN PO_SLIP_TRN_/*$domainId*/ POS ON POL.PO_SLIP_ID = POS.PO_SLIP_ID
	/*END*/
/*BEGIN*/
WHERE
	/*IF addPOrderInfo == true */
